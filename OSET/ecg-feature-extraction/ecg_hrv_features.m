...
feature_vec = [features.RMSSD, features.SDNN, features.HR_median, features.HR_mean, features.HR_upper_5, features.HR_lower_5,...
    features.hrf_pip, features.hrf_ials, features.hrf_pnn_ss, features.hrf_pnn_as];
% Define feature info
feature_info.names = {'rmssd', 'sdnn', 'hr_median', 'hr_mean', 'hr_upper_5', 'hr_lower_5',...
    'hrf_pip', 'hrf_ials', 'hrf_pnn_ss', 'hrf_pnn_as'};
feature_info.units = { 'ms', 'ms', 'bpm', 'bpm', 'bpm', 'bpm','scaler','scaler','scaler','scaler'};
feature_info.description = {"Root Mean Square of Successive Differences for HRV", ...
